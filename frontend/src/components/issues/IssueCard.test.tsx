...
describe('IssueCard', () => {
  ...
  it('should apply selected styles when selected prop is true', () => {
    const { container } = render(
      <IssueCard issue={mockIssue} selected={true} />
    );
  ...
  it('should not apply selected styles when selected prop is false', () => {
    const { container } = render(
      <IssueCard issue={mockIssue} selected={false} />
    );
  ...
  it('should truncate long summary text', () => {
    const longSummaryIssue = {
      ...mockIssue,
      summary:
        'This is a very long summary that should be truncated when displayed in the card',
    };
