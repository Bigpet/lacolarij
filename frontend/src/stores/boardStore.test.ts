...
describe("boardStore", () => {
  ...
  describe("toggleFilter", () => {
    ...
    it("should handle multiple filters", () => {
      ...
      expect(useBoardStore.getState().activeFilters).toEqual(["urgent", "bug", "frontend"]);
    });
  ...
  describe("updateColumnStatuses", () => {
    it("should update statuses for a column", () => {
      ...
      useBoardStore.getState().updateColumnStatuses("todo", ["To Do", "Backlog"]);
    ...
    it("should not affect other columns", () => {
      const originalInProgressStatuses = ["In Progress", "In Review", "In Development", "Testing"];
  ...
  describe("resetColumns", () => {
    it("should reset columns to default configuration", () => {
      ...
      expect(resetInProgress?.statuses).toEqual(["In Progress", "In Review", "In Development", "Testing"]);
    });
    ...
    it("should restore all three default columns", () => {
      ...
      expect(useBoardStore.getState().columns.map((c) => c.id)).toEqual(["todo", "in-progress", "done"]);
    });
  });
});
