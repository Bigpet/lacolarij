...
`DELETE /rest/api/2/project/{projectIdOrKey}/classification-level/default`
...
`GET /rest/api/2/project/{projectIdOrKey}/classification-level/default`
...
`PUT /rest/api/2/project/{projectIdOrKey}/classification-level/default`
