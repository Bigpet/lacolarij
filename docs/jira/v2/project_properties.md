...
- **projectIdOrKey** (path): The project ID or project key (case sensitive).
- **propertyKey** (path): The project property key. Use [Get project property keys](#api-rest-api-2-project-projectIdOrKey-properties-get) to get a list of all project property keys.
