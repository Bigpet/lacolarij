...
- **issueSecuritySchemeId** (path): The ID of the issue security scheme. Use the [Get issue security schemes](#api-rest-api-2-issuesecurityschemes-get) operation to get a list of issue security scheme IDs.
...
- **id** (path): The ID of the issue security level.
