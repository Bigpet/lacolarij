...
- **issueTypeId** (path): The ID of the issue type.
- **propertyKey** (path): The key of the property. Use [Get issue type property keys](#api-rest-api-3-issuetype-issueTypeId-properties-get) to get a list of all issue type property keys.
